        ...
        return(
            <div className="section" style={{width: "100%"}}>
                <div className="content">
                    ...
                    <div>
                        <p style={questionTextStyle}>Please click on the picture, which best represents your current feelings (negative to positive).</p>
                    ...
                    <div style={{marginTop: "50px"}}>
                        <p style={questionTextStyle}>Please click on the picture, which best represents your current feelings (calm to excited).</p>
                        <div className="row" style={{display: "flex"}}>
