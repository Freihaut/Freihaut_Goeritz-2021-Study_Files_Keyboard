...
export default class CountTask_Demo extends Component{
    ...
    startTask() {
        ...
        if (this.state.taskCount < (this.phase === "Pr" ? 3 : 7)) {
            ...
            if (this.phase === "Pr") {
                document.body.classList.add("is-clipped");
                this.props.showMouseCursor();
                // end the task after a xx second LabStudyEnd screen
                this.setState(() => ({
                    taskActive: false,
                    practiceEnd: true
                }))
    ...
    // Helper for the practice LabStudyEnd (copied from the count task answer)
            ...
            <div style={{maxWidth: "900px"}}>
                <div>
                    <p style={{fontSize: "45px", fontWeight: "bold"}}>
                        Prepare to count squares in <Timer time={3}
                ...
                <div className="modal-content">
                    ...
                    <section className="modal-card-body">
                        <div className="content">
                            <h3>Additional Task "Counting Squares"</h3>
                            <p>
                                In this task, you will see different geometrical figures in several trials for a few seconds. Your task is to <strong>count the total number of <u>squares</u> across all trials</strong>.
                            </p>
                            <p>
                                Next to the squares you will see other figures. Do not count them, but <strong>only the squares</strong>.
                            </p>
                            <p>
                                <strong>Example:</strong> In the first trial you see a total of 7 figures and count 4 squares. In the second trial, you count 3 squares and in the third trial you count another 2 squares. In total you have counted a total of 4 + 3 + 2 = 9 squares during all three trials.
                            </p>
                            <p>
                                <strong>Note:</strong> It may happen that you do not manage to count all the squares per trial. In this case, do not abort the task, but try to estimate the number of squares during the trial and continue your count in the next trial.
                            </p>
                        </div>
                    </section>
                    <footer className="modal-card-foot">
                        <button className="button is-link" onClick={this.initializeTask}>Start practice task</button>
                    </footer>
                </div>
            </div>
        );
            ...
            <div>
                <div className="section">
                    <div className="content" style={{width: "900px"}}>
                        ...
                        <div>
                            <h4>
                                The practice task is finished.
                            </h4>
                            <h4>How many squares did you count?</h4>
                            ...
                            <p style={(!this.state.validSolution)
                                ? {visibility: "visible"} : {visibility: "hidden"}} className="help is-danger">Invalid input. Only numbers are valid input
                            </p>
                            {<div style={this.state.showSolution ? {visibility: "visible", marginTop: "30px"} : {visibility: "hidden", marginTop: "30px"}}>
                                <p>
                                    <strong>
                                        {this.state.givenSolution === this.state.numTargets ? "Correct: " : "Wrong: "}
                                        The solution is {this.state.numTargets}
                                    </strong>.
                                    You should have counted <span>{this.state.numTargetsTrial[0]}</span> squares in the first trial, <span>{this.state.numTargetsTrial[1]}</span> squares
                                    in the second trial and  <span >{this.state.numTargetsTrial[2]}</span> squares in the third trial.
                                </p>
                                <p>
                                    If you want to repeat the practice task, click „Repeat practice task“, otherwise click „continue“.
                                </p>
                                <div className={"field is-grouped is-grouped-centered"} style={{marginTop: "58px"}}>
                                    <div className="control">
                                        <button className="button is-link" onClick={() => this.restart()}>Repeat practice task</button>
                                    </div>
                                    <div className="control">
                                        <button className="button is-link" onClick={() => this.endTask()}>Continue</button>
                                    </div>
                                </div>
                            </div>}
                        </div>
